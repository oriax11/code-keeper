...
Build and optimize a complete CI/CD pipeline for a microservices application. Deploy to staging and production environments while ensuring security, automation, and reliability throughout the process.
...
- Implement infrastructure provisioning with Terraform and Ansible.
- Build and scan Dockerized applications.
- Deploy applications to staging and production.
- Analyze pipeline performance and security.
...
To further enhance the learning experience and assess the learner's knowledge
of DevOps concepts and practices, we will include a role play question session
as part of the project. This exercise will require learners to apply their
